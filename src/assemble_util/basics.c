...
instr_t sdt(seg_t sf, seg_t u, seg_t l, seg_t offset, seg_t xn, seg_t rt)
{
    return (1 << 31) | (sf << 30) | (0b1110 << 26) | (u << 24) | (l << 22) | (offset << 10) | (xn << 5) | rt;
}

// load literal
instr_t ll(seg_t sf, seg_t simm19, seg_t rt)
{
    return (0 << 31) | (sf << 30) | (0b0110 << 26) | (simm19 << 5) | rt;
}
